...
class Request(models.Model):
    ...
    sales = models.ForeignKey(Profile, on_delete=models.SET_NULL, null=True, blank=True,  limit_choices_to={'isSaler': True}, related_name='saler_request')
    faction = models.ForeignKey(Faction, on_delete=models.SET_NULL, null=True, blank=True, related_name='faction_request')
    consultant = models.ForeignKey(Profile, on_delete=models.SET_NULL, null=True, blank=True, related_name='consultant_request')
